...
class WatiNotification(Notification):
    ...
    def validate_wati_settings(self):
        if (
            ...
            and self.custom_whatsapp_app == APP_TITLE
    ...
    def send(self, doc):
        ...
        try:
            if self.channel == "WhatsApp" and self.custom_whatsapp_app == APP_TITLE:
    ...
    def send_whatsapp_msg(self, doc, context):
        whatsapp_template = self.wati_whatsapp_template
        ...
        for k, v in params.items():
            if (
                ...
                and self.attach_print
                and self.print_format != ""
            ):
                url = (
    ...
    def get_documents_for_today(self):
        ...
        if self.event == "Every Year":
            ...
            WHERE
                {} like '%{}%'
            """.format(
                    self.document_type, self.date_changed, nowdate()[4:]
                ),
                as_dict=1,
            )
        else:
