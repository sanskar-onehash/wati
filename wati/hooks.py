...
app_description = "Wati Integration"
...
# web_include_js = "/assets/wati/js/wati.js"

# include custom scss in every website theme (without file extension ".scss")
# website_theme_scss = "wati/public/scss/website"
...
# before_app_install = "wati.utils.before_app_install"
# after_app_install = "wati.utils.after_app_install"
...
# before_app_uninstall = "wati.utils.before_app_uninstall"
# after_app_uninstall = "wati.utils.after_app_uninstall"

# Desk Notifications
# ------------------
# See frappe.core.notifications.get_notification_config

# notification_config = "wati.notifications.get_notification_config"
...
# before_tests = "wati.install.before_tests"
...
# Request Events
# ----------------
# before_request = ["wati.utils.before_request"]
# after_request = ["wati.utils.after_request"]

# Job Events
# ----------
# before_job = ["wati.utils.before_job"]
# after_job = ["wati.utils.after_job"]
